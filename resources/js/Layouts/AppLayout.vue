<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 overflow-y-auto" scroll-region>
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            ...
                            <div class="hidden space-x-2 lg:space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link v-show="isNotJabatan('Funding')" :href="route('transaksi.index')"
                                    ...
                                    <template #trigger>
                                        ...
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                ...
                                                {{ $page.props.user.karyawan.nama }} - {{
                                                    $page.props.user.karyawan.jabatan.nama }}
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link :href="route('dashboard')" :active="route().current('dashboard')">
                                ...
                                <jet-responsive-nav-link :href="route('simpanan.index')"
                                    :active="route().current('simpanan.index') || route().current('simpanan.search')">
                                    Simpanan
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link :href="route('pembiayaan.index')"
                                    :active="route().current('pembiayaan.index') || route().current('pembiayaan.search')">
                                    Pembiayaan
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link :href="route('kas.index',1)" v-show="isNotJabatan('Funding')"
                                    :active="route().current('kas.index', 1) || route().current('kas.index', 2)">
                                    Kas
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link v-show="isNotJabatan('Funding')" :href="route('nisbah.index')"
                                    :active="route().current('nisbah.index')">
                                    Nisbah
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link v-show="isNotJabatan('Funding')" :href="route('transaksi.index')"
                                    :active="route().current('transaksi.index')">
                                    Transaksi
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link v-show="isJabatan('Manajer')" :href="route('karyawan.index')"
                                    :active="route().current('karyawan.index') || route().current('karyawan.search')">
                                    Karyawan
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link v-show="isJabatan('Manajer')" :href="route('group.index')"
                                    :active="route().current('group.index')">
                                    Group
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link :href="route('anggota.index')"
                                    :active="route().current('anggota.index') || route().current('anggota.search')">
                                    Anggota
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link v-show="isNotJabatan('Funding')" :href="route('laba.index')"
                                    :active="route().current('laba.index')">
                                    Laba
                                </jet-responsive-nav-link>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            <div>
                                <div class="font-medium text-base text-gray-800">{{ $page.props.user.karyawan.nama }}</div>
