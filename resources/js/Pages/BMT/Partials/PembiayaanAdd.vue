  ...
  <div>
    ...
    <v-modal ref="addModal">
      ...
      <form @submit.prevent="createPembiayaan">
        ...
        <v-input :name="'jenis_pembiayaan_id'" v-model="form.jenis_pembiayaan_id"></v-input>
        <v-input :name="'simpanan_id'" v-model="form.simpanan_id"></v-input>
        <v-input :name="'karyawan_id'" v-model="form.karyawan_id"></v-input>
        <v-input :type="'date'" :name="'tanggal_pinjam'" v-model="form.tanggal_pinjam"></v-input>
        <v-input :name="'jumlah'" v-model="form.jumlah"></v-input>
        <v-input :type="'date'" :name="'tanggal_jatuh_tempo'" v-model="form.tanggal_jatuh_tempo"></v-input>
        <v-input :name="'pokok'" v-model="form.pokok"></v-input>
        <v-input :name="'jasa'" v-model="form.jasa"></v-input>
        <v-input :name="'potongan_pembiayaan'" v-model="form.potongan_pembiayaan"></v-input>
        <v-input :name="'total_pembiayaan'" v-model="form.total_pembiayaan"></v-input>
        <v-input :name="'frekuensi_angsuran'" v-model="form.frekuensi_angsuran"></v-input>
        <v-input :name="'jumlah_angsuran'" v-model="form.jumlah_angsuran"></v-input>
        <v-input :name="'angsuran_diterima'" v-model="form.angsuran_diterima"></v-input>
