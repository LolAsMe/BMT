<template>
  <div>
    ...
    <v-modal ref="addModal">
      <template #title> Add Jenis Pembiayaan </template>
      <form @submit.prevent="createJenisPembiayaan">
...
export default defineComponent({
  ...
  methods: {
    async createJenisPembiayaan() {
      await this.form.post(route("jenis-pembiayaan.store"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
