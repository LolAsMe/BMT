<template>
    <app-layout title="Pembiayaan">
        <template #header>
            <h2 class="font-bold border-b-2 mb-2 uppercase">{{ "Pembiayaan" }}
            </h2>
        ...
        <div class="py-5">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-row-reverse flex-nowrap">
                    ...
                    <button v-show="isNotJabatan('Funding')"  @click="$inertia.get(route('pembiayaan.create'))"
            ...
            <v-card>
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 ">
                        <tr class="hover:bg-slate-100 cursor-pointer odd:bg-white even:bg-slate-50" v-for="(pembiayaan, index) in paginate.data"
                            ...
                            <td class="whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="ml-0">
                                        ...
                                        <div class="text-sm font-normal text-gray-900 border-t-2 border-red-200">
                                            Angsuran Diterima :{{ Math.round((pembiayaan.angsuran_diterima) / pembiayaan.jumlah_angsuran)
                                            }}
                                        </div>
                                    </div>
                                </div>
